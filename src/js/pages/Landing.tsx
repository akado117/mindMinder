          ...
          <div className="formcontentcontainer">
            <div id="formcontent">
              <div className="errorMsg"
                style={{backgroundColor: 'orange', color: 'white', padding: '.8rem 1.3rem', textAlign: 'center', marginBottom: '1rem', display: 'none'}}>
        ...
        <main>
            <div id="hero">
              <div className="containersite_cuminu">
                <div id="middlehero">
                  <img style={{width: '40px', height: '40px', objectFit: 'contain'}} src="img/swap.png" />
            ...
            <div id="tokenomics">
              <div className="containersite_cuminu">
                <div id="middletokenomics">
                  <img style={{width: '40px', height: '40px', objectFit: 'contain'}} src="img/dual-chain.png" />
            ...
            <div id="introtipinu">
              <div className="containersite_cuminu">
                <img style={{width: '40px', height: '40px', objectFit: 'contain'}} src="img/tipinu.png" />
